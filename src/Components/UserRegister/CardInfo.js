  ...
  const fetchData = async () => {
    try {
      ...
      if (userData && userData.payment) {
        ...
        const currentUserData = userData.payment.find(payment => payment.eventid === id);
            ...
            <Row gutter={16}>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <Input name="firstName" value={formData.firstName} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  <label>Last Name</label>
                  <Input name="lastName" value={formData.lastName} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <Input name="creditCardType" value={formData.creditCardType} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  <label>Credit Card Number</label>
                  <Input name="creditCardNumber" value={formData.creditCardNumber} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <Input name="expiryDate" value={formData.expiryDate} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
              <Col span={12}>
                <div style={{ marginBottom: '15px' }}>
                  <label>CVV</label>
                  <Input name="cvv" value={formData.cvv} onChange={handleChange} disabled={disable}/>
                </div>
              </Col>
            </Row>
            <div style={{ marginBottom: '20px' }}>
              <label>Billing Address</label>
              <Input.TextArea name="billingAddress" value={formData.billingAddress} onChange={handleChange} disabled={disable}/>
            </div>
          </div>
          <div style={{ width: "96%", display: "flex", justifyContent: "flex-end", gap: "1rem", padding: '15px' }}>
            <Button>
              <NavLink to={`/userregister/${id}`}>Back</NavLink>
            </Button>
            <Button type="primary" htmlType="submit" style={{ marginRight: '10px' }} onClick={handleSubmit} disabled={disable}>
              Save
            </Button>
